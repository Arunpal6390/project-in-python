# Python program for Arrange words game.
...
def play():
	...
	while True:
		...
		qn = Arrange(picked_word)
		print("Arrange the letters to form a valid word:", qn)
		...
		if turn % 2 == 0:
			...
			# if turn no. is even
			# player1 turn
			print(p1name, 'Your Chance.')

			ans = input("what is in your word in mind? ")
